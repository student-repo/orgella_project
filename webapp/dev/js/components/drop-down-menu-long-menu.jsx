        ...
        return (
            <SelectField
                ...
                {offerShipmentPossibilities.map(key => {
                    ...
                    return (
                        <MenuItem value={key.ShipmentID - 1} key={key.ShipmentID - 1} primaryText={shipmentPossibility[key.ShipmentID - 1].ShipmentName + " $" + shipmentPossibility[key.ShipmentID - 1].Price} />
                    )
                })}
            </SelectField>
        )
